...
const FirstPage = () => {
  ...
  return (
    <div className='grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-[1200px] md:h-[70vh] mx-auto py-8 bg-black h-full'>
      <div className='col-span-2 px-5 my-auto'>
        <h1 className='text-white text-2xl sm:text-4xl lg:text-8xl '>
          ...
          <TypeAnimation
            ...
            speed={50}
            repeat={Infinity}
            className='text-xl sm:text-4xl lg:text-6xl font-serif'
          />
        </h1>
      ...
      <div className='col-span-1 my-auto mx-auto w-[300px] h-auto lg:w-[400px] rounded-full overflow-hidden relative bg-gradient-to-r from-gray-900 to-black p-4 shadow-2xl'>
  {/* Animated image with floating and hover effects */}
  <img 
    src={studying} 
    alt='My image' 
    className='w-full h-auto rounded-full animate-float transition-transform duration-500 ease-in-out hover:scale-110 shadow-xl' 
  />
</div>
