...
const NavBar = () => {
  ...
  return (
    <div className='bg-black text-gray-400 h-[100px] max-w-[1200px] mx-auto flex justify-between items-center'>
      ...
      <div className={nav ? 'fixed h-full left-0 top-0 w-[60%] bg-[#202121] ease-in-out duration-500 z-20' : 'fixed left-[-100%]'}>
        <h1 className='text-3xl primary-color m-4'>Haritha Kadali</h1>
